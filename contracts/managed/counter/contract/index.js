...
export class Contract {
  ...
  _increment_0(context, partialProofData) {
    const privateSecret_0 = this._secret_0(context, partialProofData);
    const isValid_0 = privateSecret_0 > 0n;
    isValid_0;
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 32 char 13: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
